...
% Escreva o seu texto nesse espaço.
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        Sejam os conjuntos $A = \{2, 4, 6\}, B = \{3, 6, 9\}, \mathbb{U} = A \cup B$. Assim, temos:
        \begin{align*}
        (A \cap B)^C &\ne A^C \cap B^C \\ =
        ...
        \begin{align*}
            ...
            \{3, 9\} \cup \{2, 4\} &= \{2, 3, 4, 9\}
        \end{align*}
        Assim, concluímos que os conjuntos são iguai    s.
        \end{enumerate}
    \item \enquote{As igualdades abaixo acerca dos conjuntos $A, B, C$ não são válidas geralmente. Em cada um dos itens, dê um exemplo que ilustre esse fato:}
    \begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{align*}
           ...
           \mathbb{U}
           %A \cup (B^C \cup C)^C \cup C \quad \text{(DeMorgan)} \\
           %[A \cup (B \cap C^C)] \cup C \cup (A^C \cap B^C \cap C^C) \quad (\text{Comutividade}) &\\ =
           %(A \cup B) \cap (A \cup C^C) \cup C \cup (A^C \cap B^C \cap C^C) \quad (\text{Distributividade}) &\\ =
           %(A \cup B) \cap A \cup (C^C \cup C) \cup (A^C \cap B^C \cap C^C) \quad (\text{Associatividade}) &\\ =
           %(A \cup B) \cap (A \cup \mathbb{U}) \cup (A^C \cap B^C \cap C^C) \quad (C^C \cup C = \mathbb{U}) &\\ =
           % A \cup (B \cap C^C) \cup A^C \cap (B \cup C) \cup C  &\quad (\text{DeMorgan})
           %\\ \implies 
           %A \cup (B \cap C^C) \cup (A^C \cup B) \cap (A^C \cup C^C) \cup C &\quad (\text{Distributividade})
           %\\ \implies
           %A \cup (B \cap C^C) \cup (A^C \cup B) \cap A^C \cup \mathbb{U} &\quad (C^C \cup C = \mathbb{U})
           %\\ \implies
           %A \cup (B \cap C^C) \cup A^C \cup (B \cap A^C) \cup \mathbb{U} &\quad (\text{Associatividade})
           %\\ \implies 
           %(A \cup B) \cap (A \cup C^C) \cup (A^C \cup B) \cap (A^C \cup A^C) \cup \mathbb{U} &\quad (\text{Distributividade}) \\
        \end{align*}
    ...
    \begin{enumerate}
        ...
        $
    \end{enumerate}
    \item \enquote{Reduza as expressões abaixo a um intervalo ou a união de intervalos disjuntos.}
    \begin{enumerate}
        \item $[12; 36[ \cup [-2; 37]$;\\
        ...
        \begin{tikzpicture}
            ...
            \draw[fill=white] (4.7,0) circle (2pt);
            
            % Rótulos
            \node[above] at (1,0.2) {$12$};
            \node[above] at (4.7,0.2) {$36$};
        \end{tikzpicture}
        \\
        \begin{displaymath}
            \cup
        ...
        \begin{tikzpicture}
            ...
            \node[above] at (5,0.2) {$37$};
        \end{tikzpicture}

        \emph{Resolução:} $[-2; 37]$. \\
        
        \item $]-\infty; -2[ \cap ]-1; -\dfrac{1}{2}[;$
        ...
        \begin{tikzpicture}
            ...
            % Rótulos
            \node[above] at (-2.5,0.2) {$-\infty$};
            \node[above] at (5,0.2) {$-2$};
        \end{tikzpicture}
        \\
        \begin{displaymath}
            \cap
        ...
        \begin{tikzpicture}
            ...
            \draw[fill=white] (2.5,0) circle (2pt);
            
            % Rótulos
            \node[above] at (0,0.2) {$-1$};
            \node[above] at (2.5,0.2) {$-\dfrac{1}{2}$};
        \end{tikzpicture}
        
        \emph{Resolução:} $]-\infty; -\dfrac{1}{2}[$.\\

        \item $([4; 6] \cup ]5; 8]) \cap ([4;6] \cup [4; 9[)$; \\
        Vou simplificar e considerar os novos intervalos gerados a partir das uniões:\\
        \begin{tikzpicture}
             % Linha horizontal
            \draw[-] (-3,0) -- (7,0);
...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item $(X^C \cup Y)^C = (\{2, 3, 6, 8\} \cup \{2, 4, 6, 7\})^C = (\{2, 3, 4, 6, 7, 8\})^C = \{1, 5\} $
        \item $(X^C \cup Y) \cup Z^C = (\{2, 3, 6, 8\} \cup \{2, 4, 6, 7\}) \cup \{1, 4, 2\} = \{1, 2, 3, 4, 6, 7, 8\} $
        \item $(X^C \cap Y) \cup (X \cap Z^C) = \\ 
        (\{2, 3, 6, 8\} \cap ) \cup ( \cap ) =
        $
        \item 
