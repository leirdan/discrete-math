...
\begin{enumerate}
    ...
    \item \textbf{Definição 2}: um número $a$ é par se $2|a$, ou seja, se existe $a \times 2 = b$.
    \begin{itemize}
        \item \emph{Tentativa de} Prova: Suponha, por negação, que $a \times 2 \ne b$. Tomando $a$ como 4 e $b$ como 8, teremos a expressão $4 \times 2 \ne 8$, o que é um absurdo. Logo, se $a \times 2 \ne b$ é falso, o contrário é verdadeiro.
    \end{itemize}
